...
plot(d[filt], climateData.ET.HargreavesSamani$temporal.mean$ET_mm[filt],
...
lines(d[filt], climateData.ET.JensenHaise$temporal.mean$ET_mm[filt],
            col='red',lty=1)
...
lines(d[filt], climateData.ET.Makkink$temporal.mean$ET_mm[filt],
            col='green',lty=1)
...
lines(d[filt], climateData.ET.McGuinnessBordne$temporal.mean$ET_mm[filt],
            col='blue',lty=1)
...
lines(d[filt], climateData.ET.MortonCRAE.potentialET$temporal.mean$ET_mm[filt],
            col='black',lty=2)
...
lines(d[filt], climateData.ET.MortonCRAE.wetarealET$temporal.mean$ET_mm[filt],
            col='red',lty=2)
...
lines(d[filt], climateData.ET.MortonCRAE.actualarealET$temporal.mean$ET_mm[filt],
            col='green',lty=2)
...
lines(d[filt], climateData.ET.MortonCRWE$temporal.mean$ET_mm[filt],
            col='blue',lty=2)
...
lines(d[filt], climateData.ET.MortonCRWE.shallowLake$temporal.mean$ET_mm[filt],
            col='black',lty=3)
...
lines(d[filt], climateData.ET.Turc$temporal.mean$ET_mm[filt],
            col='red',lty=3)
