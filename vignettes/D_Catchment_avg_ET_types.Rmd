...
#| fig.width = 8,
#| fig.height = 10
filt = climateData.ET.HargreavesSamani$temporal$Location.ID==407214
...
filt = climateData.ET.JensenHaise$temporal$Location.ID==407214
...
filt = climateData.ET.McGuinnessBordne$temporal$Location.ID==407214
...
filt = climateData.ET.MortonCRAE.potentialET$temporal$Location.ID==407214
...
filt = climateData.ET.MortonCRAE.wetarealET$temporal$Location.ID==407214
...
filt = climateData.ET.MortonCRAE.actualarealET$temporal$Location.ID==407214
...
filt = climateData.ET.MortonCRWE$temporal$Location.ID==407214
...
filt = climateData.ET.MortonCRWE.shallowLake$temporal$Location.ID==407214
...
filt = climateData.ET.Turc$temporal$Location.ID==407214
