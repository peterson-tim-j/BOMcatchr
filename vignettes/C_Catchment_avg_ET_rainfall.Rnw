...
Now let's compare the two estimates of precipitation, PET and rainfall deficit. The right most plots below show the rainfall deficit. It shows that using centroid estimate introduced a mean error of 8 - 18  mm/month.
```{r}
#| fig.width = 8,
#| fig.height = 6
