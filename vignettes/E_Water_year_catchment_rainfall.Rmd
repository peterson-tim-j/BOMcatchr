...
for (i in 1:length(catch$CatchID)) {
  ...
  filt = climateData.annual$temporal$Location.ID == catch$CatchID[i]
...
for (i in 1:length(catch$CatchID)) {
  ...
  filt = climateData.month2wateryear$temporal$Location.ID == catch$CatchID[i]
  ...
  # Get water year data from daily data.
  filt = climateData.daily2wateryear$temporal$Location.ID == catch$CatchID[i]
...
for (i in 1:length(catch$CatchID)) {
  ...
  # Water years precipitation from monthly data.
  filt = annom.seaonal$temporal$Location.ID == catch$CatchID[i]
